...
```
 ...
 └──────┘      └──────┘      └──────┘      └──────┘      └──────┘      └──────┘
  /my_spec       /my_plan       /my_build     /my_test      /my_review    /my_ship
```
...
|-------------------|---------|---------------|
| Define what to build | `/my_spec` | Spec before code |
| Plan how to build it | `/my_plan` | Small, atomic tasks |
| Build incrementally | `/my_build` | One slice at a time |
| Prove it works | `/my_test` | Tests are proof |
| Review before merge | `/my_review` | Improve code health |
| Simplify the code | `/code-simplify` | Clarity over cleverness |
| Ship to production | `/my_ship` | Faster is safer |
