...
While it is possible to recreate `/my_spec`, `/my_plan`, and other commands in OpenCode, this integration intentionally uses an agent-driven approach instead:
...
This replaces slash commands like `/my_spec`, `/my_plan`, etc.
