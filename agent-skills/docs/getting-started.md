...
|---------|---------------|
| `/my_spec` | spec-driven-development |
| `/my_plan` | planning-and-task-breakdown |
| `/my_build` | incremental-implementation + test-driven-development |
| `/my_test` | test-driven-development |
| `/my_review` | code-review-and-quality |
| `/my_ship` | shipping-and-launch |
...
The `/my_spec` and `/my_plan` commands create working artifacts (`SPEC.md`, `tasks/plan.md`, `tasks/todo.md`). Treat them as **living documents** while the work is in progress:
